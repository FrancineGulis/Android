...
public class StudentOperations {
    ...
    public  Student addStudent(String name){
        ...
        Cursor cursor = database.query(SimpleBDWrapper.STUDENTS,
                STUDENT_TABLE_COLUMNS, SimpleBDWrapper.STUDENTS_ID + " = "
    ...
    public void deleteStudent(Student comment){
        ...
        database.delete(SimpleBDWrapper.STUDENTS, SimpleBDWrapper.STUDENTS_ID
                    + " = " + id, null);
    }
