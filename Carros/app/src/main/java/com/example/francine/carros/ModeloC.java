...
public class ModeloC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] modelo = new String[]{"Onix", "Classic", "Montana"};
        float[] valor = new float[]{27000.00f, 25000.00f, 37000.00f};
        Integer[] imageId = {R.drawable.onix, R.drawable.classic, R.drawable.montana};
